...
# ------------------------------------------------------------------------------------------------------------ #
"""
PIBT: w = 0.1, d_max = 2, gamma = 3, k = 2
"""
...
alg_list_pibt = [
    ...
    # }),
    (run_lifelong_pibt, {
        'alg_name': f'L-PIBT+GP',
        'to_render': False,
        'k_limit': 2,
        'w': 0.8, 'd_max': 1, 'gamma': 1,
    }),
    # (run_lifelong_lacam, {
    #     'alg_name': f'L-LaCAM',
    #     'to_render': False,
...
(run_lifelong_pibt, {
        'k_limit': (k_limit := 2),
        'w': (w := 0.5), 'd_max': (d_max := 2), 'gamma': (gamma := 3),
        'alg_name': f'{w=}',
        'to_render': False,
    }),
(run_lifelong_pibt, {
        'k_limit': (k_limit := 2),
        'w': (w := 1), 'd_max': (d_max := 2), 'gamma': (gamma := 3),
        'alg_name': f'{w=}',
        'to_render': False,
    }),
# (run_lifelong_pibt, {
...
alg_list_pibt_params_d_max = [
    ...
    (run_lifelong_pibt, {
        'k_limit': (k_limit := 2),
        'w': (w := 0.1), 'd_max': (d_max := 1), 'gamma': (gamma := 3),
        'alg_name': f'{d_max=}',
        'to_render': False,
    }),
    (run_lifelong_pibt, {
    ...
    (run_lifelong_pibt, {
        'k_limit': (k_limit := 2),
        'w': (w := 0.1), 'd_max': (d_max := 3), 'gamma': (gamma := 3),
        'alg_name': f'{d_max=}',
        'to_render': False,
    }),
    (run_lifelong_pibt, {
